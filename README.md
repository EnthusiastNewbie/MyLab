...
| **[🛠️ Newbie_Sistem_Manager](./Newbie_Sistem_Manager)** | **Gestione sistema per pigri.**<br>Un'interfaccia a menu testuale (TUI) per eseguire i comandi di manutenzione più comuni senza doverli digitare ogni volta. | ![Bash](https://img.shields.io/badge/Bash_Scripting-4EAA25?style=flat-square) ![Automation](https://img.shields.io/badge/Tools-ff00ff?style=flat-square) |
